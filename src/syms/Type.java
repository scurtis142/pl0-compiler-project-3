...
public abstract class Type {
    ...
    public static class ProcedureType extends Type {
         ...
         */
        List<SymEntry.ParamEntry> formalParams;
        ...
        public ProcedureType resolveType() {
            if (!resolved) {
                for (SymEntry param : formalParams) {
                    param.resolve();
                }
            }
            resolved = true;
         ...
         * requires resolved
         */
        public List<SymEntry.ParamEntry> getFormalParams() {
            return formalParams;
        }

        public void setFormalParams(List<SymEntry.ParamEntry> params) {
    ...
    public SetType getSetType() {
        ...
        if (thisType instanceof SetType) {
     ...
     */
    public final int maxElements = 32;

    public static class SetType extends Type {

        private Type elementType;

        public SetType(Location loc, Type elementType) {
            super(loc, 1);           // Type size will need to be resolved later
        ...
        public SetType resolveType() {
            ...
            if (elementType instanceof SubrangeType) {
                SubrangeType et = (SubrangeType)elementType;
        ...
        public boolean equals(Type other) {
            if (other instanceof SetType) {
                return elementType.equals(((SetType) other).elementType);
            } else {
                return false;
            }
        }
