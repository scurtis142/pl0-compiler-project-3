...
public abstract class SymEntry {
    ...
    public static class ParamEntry extends VarEntry {
        /**
         * isRef is false for a value parameter and
         * true for a reference parameter
         */
        boolean isRef;
        /**
         * Constructor for a value/reference parameter
         *
         * @param id     name of the parameter
         * @param loc    location of declaration of parameter
         * @param type   of parameter (must be ReferenceType)
         * @param isRef true if and only if this is a result parameter
         */
        public ParamEntry(String id, Location loc, Type type, boolean isRef) {
            super(id, loc, new Type.ReferenceType(type));
            this.isRef = isRef;
        }
        /**
         * @return true if and only if this is a reference parameter
         */
        ...
        /**
         * @return the space required for storing this parameter
         */
        public int getSpace() {
            return (isRef ? getType() : getType().getBaseType()).getSpace();
        }
