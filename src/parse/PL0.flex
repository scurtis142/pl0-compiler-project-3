...
"~"     { return makeToken(CUPToken.SET_COMPLEMENT); }
...
"setof"     { return makeToken(CUPToken.KW_SETOF); }
 ...
 * priority. Note that yytext returns the character string that matches
 * the pattern -- in this case the name of the identifier. 
 */
{Letter}({Letter}|{Digit})*
